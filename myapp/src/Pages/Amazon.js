  ...
  return (
    ...
    <Container fluid className="bg-dark text-white py-2">
      ...
      <Container
        ...
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/933830/pexels-photo-933830.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
      ...
      >
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="display-4 fw-bold pt-3">PYTHON, C++,Ruby and JavaScript for Artificial Intelligence</h1>
            <p className="lead fw-bold">
              This course is part of the PYTHON, C++,Ruby and JavaScript for Amazon Specialization
            </p>
            <div className="d-flex align-items-center">
              <Image
                ...
                height="50"
              />
              <h2 className="mb-0 fw-bold">AMAZON </h2>
            </div>
      ...
      <br></br>
      <div className="container mx-auto my-10 p-5 bg-slate-300">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="video-responsive">
              <iframe
                width="100%"
                height="330"
                src="https://www.youtube.com/embed/zu2DRNNw0PA?si=_yV46KrcJU7Wn709"
