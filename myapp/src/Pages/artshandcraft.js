...
const artshandcraft = () => {
  ...
  return (
    ...
    <Container fluid className="bg-dark text-white py-2">
      ...
      <Navbar expand="lg" className="bg-lime-600">
        <Container>
      ...
      <Container
        fluid
        className="bg-light py-5 text-white"
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/3772488/pexels-photo-3772488.jpeg)',
      ...
      >
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="display-4 fw-bold pt-3" style={{color:'green'}}> Drawing, Painting, Sculpture, Ceramics, Textiles And Woodcraft</h1>
            <p className="lead fw-bold" style={{color:'greenyellow'}}>
              This course is part of the Drawing, Painting, Sculpture for Arts & HandCrafts.
            </p>
            <div className="d-flex align-items-center">
              <Image
                ...
                height="55"
              />
              <h2 className="mb-0 fw-bold" style={{color:'orange'}}>ARTS & HANDCRAFTS </h2>
            </div>
            <div className="d-flex mt-3">
              <Button variant="primary" href="#">
              <Link to="/Pages/Signup" style={{color:'white'}}>Enroll for Free</Link>
              </Button>
              <h5 className="ms-3 mb-0 fw-bold" style={{ marginTop: '7px',color:'white' }}>
      ...
      <br></br>
      <div className="container mx-auto my-10 p-5 bg-lime-800">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="video-responsive">
              <iframe
                width="100%"
                height="330"
                src="https://www.youtube.com/embed/fIh17rPDMTs?si=8xNjD2M_pknKYSLV"
