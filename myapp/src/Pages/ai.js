  ...
  return (
    ...
    <Container fluid className="bg-dark text-white py-2">
      ...
      <Container
        ...
        style={{
          backgroundImage: 'url(https://cdn.pixabay.com/photo/2024/02/09/15/22/ai-generated-8563262_1280.jpg)',
      ...
      >
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="display-4 fw-bold pt-3">PYTHON, JavaScript for Artificial Intelligence</h1>
            <p className="lead fw-bold">
              This course is part of the PYTHON, JavaScript for Artificial Intelligence Specialization
            </p>
            <div className="d-flex align-items-center">
              <Image
               src="https://as1.ftcdn.net/v2/jpg/04/83/22/04/1000_F_483220405_swceekU8d0Acz6EN2NX3VqYo6KIZMUMb.jpg"
                ...
                height="50"
              />
              <h2 className="mb-0 fw-bold">ARTIFICIAL INTELLIGENCE </h2>
            </div>
      ...
      <br></br>
      <div className="container mx-auto my-10 p-5 bg-sky-950">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="video-responsive">
              <iframe
                width="100%"
                height="330"
                src="https://www.youtube.com/embed/ad79nYk2keg?si=3G_accV7J7AWoa1s"
