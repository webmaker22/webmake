  ...
  return (
    ...
    <Container fluid className="bg-dark text-white py-2">
      ...
      <Container
        ...
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/1181271/pexels-photo-1181271.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
      ...
      >
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="display-4 fw-bold pt-3">HTML, CSS, and JavaScript for Web Designing</h1>
            <p className="lead fw-bold">
              This course is part of the HTML, CSS, and JavaScript for Web Designing Specialization
            </p>
            <div className="d-flex align-items-center">
              <Image
                ...
                height="50"
              />
              <h2 className="mb-0 fw-bold">Web Design </h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="video-responsive">
              <iframe
                width="100%"
                height="330"
                src="https://www.youtube.com/embed/C72WkcUZvco?si=a-c0jP-DZXxVdGEJ"
