...
const App = () => {
  return ( <div
    ...
    style={{
      backgroundImage: `url('https://upload.wikimedia.org/wikipedia/commons/a/a5/Contemporary_Computer_Lab.jpg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original')`, // Replace with your image URL
