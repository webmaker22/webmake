  ...
  return (
    ...
    <Container fluid className="bg-dark text-white py-2">
      ...
      <Container
        ...
        style={{
          backgroundImage: 'url(https://cdn.pixabay.com/photo/2016/03/26/13/09/workspace-1280538_1280.jpg)',
      ...
      >
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="display-4 fw-bold pt-3">HTML, CSS, and JavaScript for Web Developers</h1>
            <p className="lead fw-bold">
              This course is part of the HTML, CSS, and JavaScript for Web Developers Specialization
            </p>
            <div className="d-flex align-items-center">
              <Image
                ...
                height="50"
              />
              <h2 className="mb-0 fw-bold">Full Stack Web Development</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="video-responsive">
              <iframe
                width="100%"
                height="330"
                src="https://www.youtube.com/embed/XlvsJLer_No?si=scwn-LkUrPPin9m3"
